...
![visitor badge](https://visitor-badge.laobi.icu/badge?page_id=samueljanringsitio-portfolio.visitor-badge)
...
2. Clone the repository:
   ...
   ```shell
   git clone https://github.com/samueljanringsitio/samueljs_portofolio.git
   ```
